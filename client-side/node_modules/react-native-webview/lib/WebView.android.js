...
var WebView = /** @class */ (function (_super) {
    ...
    function WebView() {
        ...
        _this.uniqueRef = uuid().replace(/-/g, '');
        _this.webViewRef = React.createRef();
        _this.componentDidMount = function () {
            BatchedBridge.registerCallableModule(_this.getMessagingModuleName(), _this);
        };
        _this.getMessagingModuleName = function () { return "WebViewMessageHandler" + _this.uniqueRef; };
    ...
    WebView.prototype.render = function () {
        ...
        var webView = (<NativeWebView key="webViewKey" {...otherProps} messagingEnabled={typeof onMessage === 'function'} messagingModuleName={this.getMessagingModuleName()} onLoadingError={this.onLoadingError} onLoadingFinish={this.onLoadingFinish} onLoadingProgress={this.onLoadingProgress} onLoadingStart={this.onLoadingStart} onHttpError={this.onHttpError} onMessage={this.onMessage} onShouldStartLoadWithRequest={onShouldStartLoadWithRequest} ref={this.webViewRef} 
