...
export default class CollectionListingItemStyleThree extends React.PureComponent {
            ...
            <TouchableOpacity  onPress={() => this.props.onPress(this.props.productId)}>
                ...
                <View style={styles.collectionItem}>
                    ...
                    <View style={styles.imagecontainer}>
                        <Image  source={{ uri: this.props.Adimage  }}  style={{ width: '100%', height: 150 , borderRadius:10}} />
                    </View>     
